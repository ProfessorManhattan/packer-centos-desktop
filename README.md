<!-- ⚠️ This README has been generated from the file(s) "./modules/docs/blueprint-readme.md" ⚠️--><h1 align="center">Packer Template for CentOS Desktop</h1>
...
<p align="center">
  <b>Packer project that builds minimal VagrantUp CentOS Desktop boxes</b></br>
</p>
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://gitlab.com/megabyte-space/packer/Base-CentOS-Desktop/-/issues). If you would like to contribute, please take a look at the [contributing guide](https://gitlab.com/megabyte-space/packer/Base-CentOS-Desktop/-/raw/master/CONTRIBUTING.md).
