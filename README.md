<!-- ⚠️ This README has been generated from the file(s) "./.modules/docs/blueprint-readme.md" ⚠️--><div align="center">
  <center>
    <a href="https://gitlab.com/megabyte-labs/packer/centos-desktop" title="CentOS Desktop 8.3 GitLab page" target="_blank">
      <img width="100" height="100" alt="CentOS Desktop 8.3 logo" src="./logo.png" />
    </a>
  </center>
</div>
<div align="center">
  <center><h1 align="center">Packer Template: CentOS Desktop 8.3</h1></center>
</div>
...
<div align="center">
  <h4 align="center">
    ...
    <a href="https://app.vagrantup.com/Megabyte/boxes/CentOS-Desktop" title="CentOS Desktop 8.3 box on VagrantUp.com" target="_blank">
...
> </br><h3 align="center">**An automated CentOS Desktop (version 8.3) Packer project that builds boxes using the latest CentOS release**</h3></br>
...
This repository contains the source code used to automatically build minimal CentOS Desktop 8.3 VM images. The build process closely imitates the same process used by [chef/bento](https://github.com/chef/bento). In fact, you will see that most of the `scripts/` folder is symlinked to a chef/bento submodule.

This repository automates most of the process of keeping our [CentOS Desktop 8.3 VM images](https://app.vagrantup.com/Megabyte/boxes/CentOS-Desktop) up-to-date with the latest upstream source by:
...
You can quickly use this project to create your own minimal CentOS Desktop 8.3 box by:
...
If a new release of the CentOS Desktop 8.3 system is available, you can update your VagrantUp box. You can do this by changing the `"iso_checksum_url"`, `"iso_url"`, and `"iso_version"` variables in the `template.json` file. After that, run `packer build -only=virtualbox-iso template.json` and you should be golden.
